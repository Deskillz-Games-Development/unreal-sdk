...
public:
    ...
    // ========================================================================
    // Authentication (Legacy - Wallet Only)
    // ========================================================================
    ...
    // ========================================================================
    // Authentication (Self-Sufficient Architecture)
    // ========================================================================
     ...
     * @param bRememberMe Keep session persistent
     */
    UFUNCTION(BlueprintCallable, Category = "Deskillz|Auth")
    void LoginWithEmail(const FString& Email, const FString& Password, bool bRememberMe = false);
     ...
     * @param IdToken Token from social provider
     */
    UFUNCTION(BlueprintCallable, Category = "Deskillz|Auth")
    void SocialLogin(const FString& Provider, const FString& IdToken);
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "Deskillz|Auth")
    void LinkWallet(const FString& WalletAddress, const FString& Signature, 
     ...
     * @param Reason Reason to show user if wallet required
     * @return True if wallet is required but not connected
     */
    UFUNCTION(BlueprintCallable, Category = "Deskillz|Auth")
    bool RequireWallet(const FString& Reason = TEXT("This action requires a connected wallet"));

    /**
     * Get the auth controller
     */
    UFUNCTION(BlueprintPure, Category = "Deskillz|Auth")
    UDeskillzAuthController* GetAuthController() const { return AuthController; }

    /**
     * Get current authenticated user (Self-Sufficient Architecture)
     */
    UFUNCTION(BlueprintPure, Category = "Deskillz|Auth")
    FDeskillzAuthUser GetCurrentAuthUser() const;
...
protected:
    ...
    // ========================================================================
    // Auth System State (Self-Sufficient Architecture)
    // ========================================================================

    /** Auth controller reference */
    UPROPERTY()
    UDeskillzAuthController* AuthController = nullptr;
    ...
    // ========================================================================
    // Auth System Methods (Self-Sufficient Architecture)
    // ========================================================================
    ...
    UFUNCTION()
    void HandleAuthLoginSuccess(const FDeskillzAuthUser& User);
    ...
    UFUNCTION()
    void HandleWalletConnected(const FString& WalletAddress);
